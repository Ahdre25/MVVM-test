...
//    var toastView: (LoaderProtocol & ToastProtocol)?
    var showLoader: Bool
    var showToast: Bool
    
    init(requestData: T1, onSuccess: ((T2) -> ())? = nil, onError: ((Int, [ErrorResponse]) -> ())? = nil, onFail: ((Error) -> ())? = nil, onParseDataError: (()->())? = nil, onRequestComplete: (()->())? = nil, showLoader: Bool = true, showToast: Bool = true) {
